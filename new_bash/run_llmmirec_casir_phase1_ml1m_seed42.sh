...
# =========================================================
# LLMMIRec CASIR Phase 1 — ML-1M seed=42
#
# Usage:
...
echo -e "${DATASET}\tLLMMIRecCASIR\t${REFINE_MODE}\t${SEMANTIC_RANK}\t${LAMBDA_RELATION}\t${SEED}\t4\t0.002\t${START_TIME}\t${END_TIME}\t${TOTAL_SECONDS}\t${PARAM_COUNT}\t${BEST_EPOCH}\t${BEST_DEV}\t${TEST_AFTER}\tOK" >> "${SUMMARY_FILE}"
