...
ROOT_LOG_DIR="new_log/mymodelv5_dspc"
ROOT_MODEL_DIR="new_model/mymodelv5_dspc"
...
run_one() {
  ...
  echo "use_dspc=${USE_DSPC}"
  echo "dspc_scale=${DSPC_SCALE}"
  echo "dspc_temp=${DSPC_TEMP}"
  echo "log=${LOG_FILE}"
  echo "========================================================="
...
# =========================================================
# Beauty 2: DSPC scale=0.02
# =========================================================
run_one \
  "beauty" \
  "MyModelV5_DSPC_s002_seed42" \
  4 \
  0.1 \
  0.2 \
  0.05 \
...
# =========================================================
# Beauty 3: DSPC scale=0.05
# =========================================================
run_one \
  "beauty" \
  "MyModelV5_DSPC_s005_seed42" \
  4 \
  0.1 \
  0.2 \
  0.05 \
...
echo ""
echo "========================================================="
echo "All MyModelV5 DSPC runs finished."
echo "Summary:"
