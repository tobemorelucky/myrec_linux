...
ROOT_LOG_DIR="new_log/shnc_3datasets_seed42"
ROOT_MODEL_DIR="new_model/shnc_3datasets_seed42"
...
run_one \
  "beauty" \
  "beauty_SHNC_lam001_num1_random_seed42" \
  0.002 \
  0.1 \
  0.2 \
  3.0 \
...
run_one \
  "ml-1m" \
  "ml1m_SHNC_lam0005_num1_random_seed42" \
  0.001 \
  0.08 \
  0.3 \
  3.0 \
...
run_one \
  "toys" \
  "toys_SHNC_lam001_num1_random_seed42" \
  0.001 \
  0.05 \
  0.5 \
  3.8 \
...
echo ""
echo "========================================================="
echo "SHNC 3 datasets seed42 finished."
echo "Summary:"
