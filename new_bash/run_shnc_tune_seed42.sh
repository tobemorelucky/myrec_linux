...
ROOT_LOG_DIR="new_log/shnc_tune_seed42"
ROOT_MODEL_DIR="new_model/shnc_tune_seed42"
...
run_one() {
  ...
  echo -e "${DATASET}\tMyModelSHNC\t${VARIANT}\t${SEED}\t${START_TIME}\t${END_TIME}\t${TOTAL_SECONDS}\t${BEST_DEV}\t${TEST_AFTER}" >> "${SUMMARY_FILE}"
}

echo ""
echo "========================================================="
echo "Start SHNC tune seed42."
echo "GPU=${GPU}"
echo "Summary file: ${SUMMARY_FILE}"
echo "========================================================="

# =========================================================
# Beauty: current best lambda=0.01
# Test smaller and larger
# =========================================================

run_one \
  "beauty" \
  "beauty_SHNC_lam0005_num1_random_seed42" \
  0.002 \
  0.1 \
  0.2 \
  3.0 \
...
run_one \
  "beauty" \
  "beauty_SHNC_lam002_num1_random_seed42" \
  0.002 \
  0.1 \
  0.2 \
  3.0 \
...
# =========================================================
# ML-1M: current lambda=0.005 hurts Top-5 slightly
# Test smaller lambda
# ML-1M checkpoint fixed by README: seed=1 checkpoint
# =========================================================

run_one \
  "ml-1m" \
  "ml1m_SHNC_lam0001_num1_random_seed42" \
  0.001 \
  0.08 \
  0.3 \
  3.0 \
...
run_one \
  "ml-1m" \
  "ml1m_SHNC_lam0002_num1_random_seed42" \
  0.001 \
  0.08 \
  0.3 \
  3.0 \
...
# =========================================================
# Toys: current lambda=0.01 has small positive signal
# Test larger lambda=0.02
# Toys checkpoint and warmup fixed
# =========================================================

run_one \
  "toys" \
  "toys_SHNC_lam002_num1_random_seed42" \
  0.001 \
  0.05 \
  0.5 \
  3.8 \
...
echo ""
echo "========================================================="
echo "SHNC tune seed42 finished."
echo "Summary:"
