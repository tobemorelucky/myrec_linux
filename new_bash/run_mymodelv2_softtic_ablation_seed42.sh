...
ROOT_LOG_DIR="new_log/mymodelv2_softtic"
ROOT_MODEL_DIR="new_model/mymodelv2_softtic"
...
run_one() {
  ...
  echo "use_soft_tic=${USE_SOFT_TIC}"
  echo "log=${LOG_FILE}"
  echo "========================================================="
  ...
  python main.py \
    ...
    --use_soft_tic "${USE_SOFT_TIC}" \
    --lambda_soft_tic 0.01 \
    --soft_tic_temp 0.5 \
...
# =========================================================
# Beauty 1: IPD only, no SICR, no Soft-TIC
# =========================================================
run_one \
  "beauty" \
  "MyModelV2_IPD_noSICR_noSoftTIC_seed42" \
  4 \
  0.1 \
  0.2 \
  0.05 \
...
# =========================================================
# Beauty 2: IPD + Soft-TIC, no SICR
# =========================================================
run_one \
  "beauty" \
  "MyModelV2_IPD_SoftTIC_noSICR_seed42" \
  4 \
  0.1 \
  0.2 \
  0.05 \
...
# =========================================================
# ML-1M 1: IU-SCBR + IPD, no Soft-TIC
# 当前较好设置：global_r=0.06
# =========================================================
run_one \
  "ml-1m" \
  "MyModelV2_IUSCBR_IPD_noSoftTIC_r006_seed42" \
  2 \
  0.08 \
  0.3 \
  0.02 \
...
# =========================================================
# ML-1M 2: IU-SCBR + IPD + Soft-TIC
# =========================================================
run_one \
  "ml-1m" \
  "MyModelV2_IUSCBR_IPD_SoftTIC_r006_seed42" \
  2 \
  0.08 \
  0.3 \
  0.02 \
...
echo ""
echo "========================================================="
echo "All Soft-TIC ablation runs finished."
echo "Summary:"
