...
# =========================================================
# LLMMIRec Phase 1 — llm_replace + relation loss control
#
# Compares llm_replace with/without semantic relation preservation.
# All non-relation params identical to Phase 0 llm_replace.
#
# Usage:
#   bash new_bash/run_llmmirec_phase1_relation_control_beauty_seed42.sh [GPU_ID]
...
echo "========================================================="
echo "LLMMIRec Phase 1 — llm_replace + relation ${SMOKE_TAG}"
