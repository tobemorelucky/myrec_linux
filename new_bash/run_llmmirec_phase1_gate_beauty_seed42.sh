...
# =========================================================
# LLMMIRec Phase 1 — ASPCF Gate ablation (Beauty seed=42)
#
# Usage:
...
echo -e "${DATASET}\tLLMMIRec\taspcf\t${GATE_MODE}\t${SEMANTIC_RANK}\t${LAMBDA_RELATION}\t${SEED}\t4\t0.008\t${START_TIME}\t${END_TIME}\t${TOTAL_SECONDS}\t${PARAM_COUNT}\t${BEST_EPOCH}\t${BEST_DEV}\t${TEST_AFTER}\t${STATUS}" >> "${SUMMARY_FILE}"
