...
# =========================================================
# LLMMIRec CAISD Phase 2 (final) — Beauty
#
# Frozen method: uniform distill + responsibility teacher,
# no relation JS, no confidence, no responsibility_power.
#
# Usage:
#   bash new_bash/run_llmmirec_caisd_phase2_beauty.sh GPU SEED
#   e.g. bash new_bash/run_llmmirec_caisd_phase2_beauty.sh 0 42
# =========================================================
