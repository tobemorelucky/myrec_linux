...
# =========================================================
# LLMMIRec Phase 0 — Beauty seed=42 baseline
#
# Usage:
#   bash new_bash/run_llmmirec_phase0_beauty_seed42.sh [GPU_ID]
#
# Background:
#   nohup bash new_bash/run_llmmirec_phase0_beauty_seed42.sh 0 \
#     > new_log/llmmirec_phase0/beauty/master_seed42.out 2>&1 &
#
# Modes: id, llm_replace, residual
# =========================================================
...
echo "========================================================="
echo "LLMMIRec Phase 0 — Beauty seed=42"
echo "GPU=${GPU}"
...
run_llmmirec() {
  ...
  echo ""
  echo "========================================================="
  echo "[START] item_encoder=${ITEM_ENCODER}, seed=${SEED}"
  ...
  if grep -q "nan\|NaN\|inf\|Inf" "${LOG_FILE}"; then
    STATUS="NaN_WARN"
  fi

  echo "========================================================="
  echo "[DONE] item_encoder=${ITEM_ENCODER}, seed=${SEED}"
...
# =========================================================
# 1. id mode (pure collaborative filtering)
# =========================================================
...
# 2. llm_replace mode
# =========================================================
run_llmmirec "llm_replace" "./data/beauty/handled/llm_table_pca1536.pkl" "0.1" "0" "llm_replace"

# =========================================================
# 3. residual mode
# =========================================================
run_llmmirec "residual" "./data/beauty/handled/llm_table_pca1536.pkl" "0.1" "0" "residual"


echo ""
echo "========================================================="
echo "All LLMMIRec Phase 0 experiments finished."
echo "Summary: ${SUMMARY_FILE}"
echo "========================================================="
