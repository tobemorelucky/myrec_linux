...
# =========================================================
# LLMMIRec Phase 0 — Toys seed=42 baseline
#
# Usage:
#   bash new_bash/run_llmmirec_phase0_toys_seed42.sh [GPU_ID]
#   SMOKE=1 bash new_bash/run_llmmirec_phase0_toys_seed42.sh [GPU_ID]
# =========================================================
...
# 2. llm_replace mode
# =========================================================
run_llmmirec "llm_replace" "./data/toys/handled/llm_table_pca1536.pkl" "0.1" "0" "llm_replace"

# =========================================================
# 3. residual mode
# =========================================================
run_llmmirec "residual" "./data/toys/handled/llm_table_pca1536.pkl" "0.1" "0" "residual"


echo ""
echo "========================================================="
echo "All LLMMIRec Phase 0 Toys experiments finished."
echo "Summary: ${SUMMARY_FILE}"
echo "========================================================="
