...
for s in "${SEEDS[@]}"; do
  launch_one "${s}" "beauty_confaware_mix05_floor015_s${s}" \
    --sadir_conf_mix 0.5 --sadir_conf_floor 0.15

  launch_one "${s}" "beauty_confaware_mix05_floor020_s${s}" \
    --sadir_conf_mix 0.5 --sadir_conf_floor 0.20

  launch_one "${s}" "beauty_confaware_mix05_floor025_s${s}" \
    --sadir_conf_mix 0.5 --sadir_conf_floor 0.25

  launch_one "${s}" "beauty_confaware_mix07_floor015_s${s}" \
    --sadir_conf_mix 0.7 --sadir_conf_floor 0.15

  launch_one "${s}" "beauty_confaware_mix07_floor020_s${s}" \
    --sadir_conf_mix 0.7 --sadir_conf_floor 0.20

  launch_one "${s}" "beauty_confaware_mix07_floor025_s${s}" \
    --sadir_conf_mix 0.7 --sadir_conf_floor 0.25
done

wait
echo "Beauty conf-aware SADIR finished. Logs in ${LOGDIR}"