...
LOGDIR="./log/MyModel/${DATASET}/sadir_history_only_s42"
MODELDIR="./model/MyModel/${DATASET}/sadir_history_only_s42"
...
########################################
# 1) gate consistency 小范围扫
########################################
launch_one "ml1m_sadir_ho_s42_gate0000" --lambda_gate_cons 0.0
launch_one "ml1m_sadir_ho_s42_gate0005" --lambda_gate_cons 0.0005
launch_one "ml1m_sadir_ho_s42_gate0010" --lambda_gate_cons 0.001

########################################
# 2) prior 强度小范围扫
########################################
launch_one "ml1m_sadir_ho_s42_prior030" --sadir_prior_lambda 0.30
launch_one "ml1m_sadir_ho_s42_prior050" --sadir_prior_lambda 0.50
launch_one "ml1m_sadir_ho_s42_prior070" --sadir_prior_lambda 0.70

wait
echo "ML-1M history-only SADIR sweep finished. Logs in ${LOGDIR}"