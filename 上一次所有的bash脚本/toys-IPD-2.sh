...
for m in "${MARGINS[@]}"; do
  wait_for_slot
  m_s="${m//./}"
  tag="toys_llm_emileIPD_tau${TAU}_g${GAMMA}_a0001_lipd005_m${m_s}_s${SEED}"
...
wait
echo "Margin sweep done. Logs in ${LOGDIR}"