...
DATASET="ml-1m"
LOGDIR="./log/MyModel/${DATASET}/final_testmultiseed_ipd002_lgd"
MODELDIR="./model/MyModel/${DATASET}/final_testmultiseed_ipd002_lgd"
...
launch_one () {
  ...
  local tag="ml1m_final_s${seed}_g008_tau03_ipd002_lgdA8_b02_top5_r008"
...
wait
echo "ML-1M multiseed finished. Logs in ${LOGDIR}"